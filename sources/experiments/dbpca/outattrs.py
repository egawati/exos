...
if __name__ == '__main__':
    ...
    basic_filename = f'{n_streams}_{bfname}_{ex_number}_OA{args.noutattrs}' ##15_10K_Case1_1_OA2
    print(f'basic filename is {basic_filename}')
    filenames = [f'{i}_{basic_filename}.pkl' for i in range(n_streams)] ##0_15_10K_Case1_1_OA2.pkl
